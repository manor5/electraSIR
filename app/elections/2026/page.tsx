                  ...
                  <Table size="small" stickyHeader sx={{ minWidth: '600px', '@media (max-width: 768px)': { minWidth: '450px' } }}>
                    <TableHead>
                      <TableRow sx={{ background: '#f8fafc' }}>
                        ...
                        <TableCell align="right" sx={{ fontWeight: 700, background: '#f8fafc', py: 1, px: 0.5, width: '50px', cursor: 'pointer', '&:hover': { background: '#e0e8f0' }, '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', py: 0.5, px: 0.1, width: '18px', fontSize: '0.6rem' } }} onClick={() => handleAgeBandSort('male_count')}>{ageBandSortBy === 'male_count' ? `Male ${ageBandSortOrder === 'asc' ? '↑' : '↓'}` : 'Male'}</TableCell>
                        <TableCell align="right" sx={{ fontWeight: 700, background: '#f8fafc', py: 1, px: 0.5, width: '50px', cursor: 'pointer', '&:hover': { background: '#e0e8f0' }, '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', py: 0.5, px: 0.1, width: '18px', fontSize: '0.6rem' } }} onClick={() => handleAgeBandSort('female_count')}>{ageBandSortBy === 'female_count' ? `Female ${ageBandSortOrder === 'asc' ? '↑' : '↓'}` : 'Female'}</TableCell>
                        <TableCell align="right" sx={{ fontWeight: 700, background: '#f8fafc', py: 1, px: 0.5, width: '50px', cursor: 'pointer', '&:hover': { background: '#e0e8f0' }, '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', py: 0.5, px: 0.1, width: '18px', fontSize: '0.6rem' } }} onClick={() => handleAgeBandSort('total_count')}>{ageBandSortBy === 'total_count' ? `Total ${ageBandSortOrder === 'asc' ? '↑' : '↓'}` : 'Total'}</TableCell>
                      ...
                      {(() => {
                        ...
                        return sortedData.map((row, idx) => (
                          <TableRow key={row.age_band}>
                            ...
                            <TableCell align="right" sx={{ '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', px: 0.1, py: 0.3, width: '18px', fontSize: '0.6rem' }, width: '50px' }}>{row.male_count}</TableCell>
                            <TableCell align="right" sx={{ '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', px: 0.1, py: 0.3, width: '18px', fontSize: '0.6rem' }, width: '50px' }}>{row.female_count}</TableCell>
                            <TableCell align="right" sx={{ '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', px: 0.1, py: 0.3, width: '18px', fontSize: '0.6rem' }, width: '50px' }}>{row.total_count}</TableCell>
                      ...
                      {ageBandData.length > 0 && (() => {
                        ...
                        return (
                          <TableRow sx={{ background: '#e8f0f7', fontWeight: 700, position: 'sticky', bottom: 0, zIndex: 10 }}>
                            ...
                            <TableCell align="right" sx={{ fontWeight: 700, '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', px: 0.1, py: 0.3, width: '18px', fontSize: '0.6rem' }, width: '50px' }}>{totalMale}</TableCell>
                            <TableCell align="right" sx={{ fontWeight: 700, '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', px: 0.1, py: 0.3, width: '18px', fontSize: '0.6rem' }, width: '50px' }}>{totalFemale}</TableCell>
                            <TableCell align="right" sx={{ fontWeight: 700, '@media (max-width: 768px)': { borderRight: '1px solid #e2e8f0', px: 0.1, py: 0.3, width: '18px', fontSize: '0.6rem' }, width: '50px' }}>{grandTotal}</TableCell>
